...
- **Loop 成熟度**：项目的"目标定义 + 评估反馈 + 迭代循环"设计是否完备？能否驱动 Agent 在长时自主运行中持续改进？
  - 评分：1-无评估无循环 2-有 pass/fail 但无量化和迭代 3-有评估和循环但缺品质锚定或退出条件 4-有 Rubric+循环+锚定+退出 5-以上全部+信息隔离+可观测性+边际效益
